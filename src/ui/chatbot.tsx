  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      role: "assistant",
      content: "Hello! I am MY AI, Ritik's personal portfolio assistant. How can I help you learn more about his skills or projects?",
    },
  ]);
            ...
            <div className="p-4 bg-white/5 border-t border-white/10 shrink-0">
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder="Ask me about Ritik..."
